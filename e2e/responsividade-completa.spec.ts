...
const rotas = [
  "/dashboard", "/clientes", "/clientes/novo", "/estoque", "/estoque/novo",
  "/vendas", "/vendas/nova", "/vendas/pedidos", "/tarefas", "/agenda",
  "/auditoria", "/automacoes/historico", "/importacao", "/inbox", "/relatorios",
