...
function Detalhes({ item }: { item: AuditItem }) {
  if (!item.antes && !item.depois) return <span className="text-muted-foreground">Sem alteração</span>;
  return (
