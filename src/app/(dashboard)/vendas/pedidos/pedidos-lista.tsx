...
import { CardResumoVendas } from "./card-resumo-vendas";
import { PedidosIndicadorDialog, type FiltrosIndicador } from "./pedidos-indicador-dialog";
import { EXPLICACAO_PENDENTES, EXPLICACOES_CARDS, explicacoesResumoVendas, legendaResumoVendas } from "./regras-resumo-vendas";
import { BotaoNotas } from "@/shared/components/notas/botao-notas";
import { notasVendas } from "./notas-vendas";
...
const resumoInicial: Resumo = {
  ...
  canceladosOperacionais: 0,
  canceladosSemPagamento: 0,
  canceladosPagamentoDesconhecido: 0,
  canceladosSemPagamentoValor: 0,
      ...
      >
        {[
          ...
          },
          {
            ...
            indicador: "cancelados-sem-pagamento" as const,
            tituloJanela: "Cancelados sem pagamento",
            label: <>Cancelados sem pagamento</>,
          ...
          },
          {
            ...
            explicacao: EXPLICACAO_PENDENTES,
          },
        ].map((card) => (
