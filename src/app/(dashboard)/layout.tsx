...
export default async function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    <div className="min-h-screen min-h-dvh bg-background">
      ...
      {/* Conteúdo principal */}
      <main className="pt-[calc(3.5rem_+_env(safe-area-inset-top))] pb-[calc(5rem_+_env(safe-area-inset-bottom))] md:pt-14 md:pb-0">
      ...
      <nav className="fixed-header-stable fixed inset-x-0 bottom-0 z-30 border-t border-border bg-card pb-[calc(env(safe-area-inset-bottom)_+_14px)] md:hidden">
