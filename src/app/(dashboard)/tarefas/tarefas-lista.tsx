  ...
  return (
    <div data-testid="tarefas-page">
      ...
      <section className="overflow-hidden rounded-2xl border border-border bg-card">
        {loading ? <div className="divide-y divide-border"><SkeletonRow /><SkeletonRow /><SkeletonRow /></div> : tarefas.length === 0 ? <EmptyState illustration="generic" title={copy.empty.title} description={copy.empty.description} /> : <>
