  ...
  const campos: CampoNumero[] = [
    ...
    },
    {
      ...
      calculo: marca.taxaCancelamento === null ? {
        titulo: "Cancelamento",
        significado: "Mostra a parcela dos pedidos do período que terminou cancelada ou devolvida. Quanto menor, mais saudável está a operação da marca.",
        formula: "pedidos cancelados ou devolvidos, divididos pelos pedidos do período que já tiveram desfecho (pagos, cancelados ou devolvidos)",
        resultado: "Sem dado",
        itens: [],
        ...
        nota: "Entram também os cancelados sem pagamento (checkout que o comprador abandonou ou deixou expirar), porque os canais registram os dois como cancelado. Por isso esta taxa pode ficar acima da que o canal mostra. Pedido ainda aguardando pagamento fica fora das duas pontas da conta. O dia é o da criação do pedido.",
      },
    },
    {
      label: "5 maiores em receita",
