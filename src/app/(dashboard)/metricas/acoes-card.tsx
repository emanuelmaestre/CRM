                        ...
                        {confianca !== null && (
                          <div className="mt-2 flex items-center gap-1.5">
                            ...
                            <CalculoPopover
                              ...
                              significado="Estimativa da própria IA sobre o quanto os dados sustentam essa leitura. Não é uma métrica medida, mas uma autoavaliação do modelo sobre a própria conclusão."
                              ...
                              nota="Trate o resultado como um indício, e não como certeza. Confira os dados brutos antes de agir somente com base nesta estimativa."
                            />
